...
if [ $1 = "--help" ]; then
     echo "USAGE: #linux_consul_install.sh <pkg [oss | ent | ent.hsm]> <product[vault | consul | nomad]> <version> <backend_storage [consul | raft]"
     exit
fi
